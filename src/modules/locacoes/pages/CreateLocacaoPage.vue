...
import { createLocacaoSchema } from '@/modules/locacoes/dtos/locacao.dto'
...
async function handleSubmit() {
  ...
  const parsed = createLocacaoSchema.safeParse({
  ...
  await submit(async () => {
    await locacaoService.create(payload)
    uiStore.notify('success', 'Locação criada com sucesso.')

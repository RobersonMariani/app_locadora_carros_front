...
<template>
  <div>
    <div class="mb-6 flex items-center justify-between">
      <h1 class="text-2xl font-bold text-gray-900">Carros</h1>
      <AppButton @click="router.push({ name: 'carros.create' })"> Novo Carro </AppButton>
    </div>

    <div class="rounded-xl bg-white shadow-sm">
      <div v-if="carrosStore.loading" class="p-8 text-center text-gray-500">Carregando...</div>

      <div v-else-if="carrosStore.carros.length === 0" class="p-8 text-center text-gray-500">
      ...
      <div v-else class="min-w-full divide-y divide-gray-200 overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="divide-y divide-gray-200 bg-white">
            <tr v-for="carro in carrosStore.carros" :key="carro.id">
    ...
    >
      <p v-if="carroToDelete" class="text-gray-600">
